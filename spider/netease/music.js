      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mX4b: function(a) {
            var c = this.i1x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Yh3x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
...
(function() {
    ...
    u.enc.Base64 = {
        ...
        bE1x: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
    }
}
)();
(function(u) {
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.FD7w, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.bjw1x, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        ml3x: function() {
            for (var a = this.J1x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.ZT3x = d + 6) + 1), e = this.bjs1x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Dz7s(a, b, this.bjs1x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Dz7s(a, c, this.bjq1x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Dz7s: function(a, b, c, d, e, j, l, f) {
            for (var m = this.ZT3x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function encryptParams(d) {
    ...
    return window.asrsea(JSON.stringify(d), e, f, g)
}

// 调用测试
// console.log(encryptParams({"key": "value"}))
...
# 调用函数
res = js_code.call("encryptParams", {"key": "value"})
*/